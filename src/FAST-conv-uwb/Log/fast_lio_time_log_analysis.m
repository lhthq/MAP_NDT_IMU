...
fast_lio_ikdtree = csvread("./fast_lio_time_log(ikd-Tree).csv",1,0);
% fov_check_time_ikd = fast_lio_ikdtree(:,5)*1e3;
tree_size_ikd = fast_lio_ikdtree(:,5);
average_time_ikd = fast_lio_ikdtree(:,2)*1e3;
total_time_ikd = fast_lio_ikdtree(:,6)*1e3;
incremental_time_ikd = fast_lio_ikdtree(:,3)*1e3;
search_time_ikd = fast_lio_ikdtree(:,4)*1e3;
timestamp_ikd = fast_lio_ikdtree(:,1);
alpha_bal_ikd = fast_lio_ikdtree(:,7);
alpha_del_ikd = fast_lio_ikdtree(:,8);
